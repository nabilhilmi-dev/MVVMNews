...
import com.example.mvvnewsapp.util.Contans
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener(){
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isNotLoadingAndLastPage = !isLoading and !isLastPage
            val isAtLastItem = firstVisibleItemPosition + visibleItemCount >=totalItemCount
            val isNotBegining = firstVisibleItemPosition >=0
            val isTotalMoreThanVisible = totalItemCount >= Contans.QUERY_PAGE_SIZE
            val shouldPaginate = isNotLoadingAndLastPage and isAtLastItem and isNotBegining and
                    isTotalMoreThanVisible and isScrolling
